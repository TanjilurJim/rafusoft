...
@section('content')
    <div class="p-3">
        ...
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Edit Product Page</h1>
        </div>
            ...
            <div>
                <div id="exTab2">
                    <ul class="nav  flex justify-between">
                        ...
                        <li><a href="#3" class="btn btn-orange" data-toggle="tab">Pdocuct Inffo</a>
                        </li>
                    ...
                    <div class="tab-content mt-5">
                        <div class="tab-pane active" id="1">
                            <div class="grid grid-cols-2 gap-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{$product->title}}" placeholder="Enter Meta Title">
                                </div>
                                <div class="form-group">
                                    <label for="meta_description">Meta Description</label>
                                    <input type="text" class="form-control" name="meta_description" value="{{$product->meta_description}}"  placeholder="Enter Meta Description">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$product->banner_h_one}}" name="banner_h_one"
                                        placeholder="Enter Heading (h1)">
                                </div>
                                <div class="form-group">
                                    <label for="banner_h_two">Banner Head (h2)</label>
                                    <input type="text" class="form-control" value="{{$product->banner_h_two}}" name="banner_h_two"
                                        placeholder="Enter Heading (h2)">
                                </div>
                                <div class="form-group">
                                    <label for="headline">Headline</label>
                                    <input type="text" class="form-control" value="{{$product->headline}}" name="headline"
                        ...
                        <div class="tab-pane" id="2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="favicon" value="{{$product->favicon}}" placeholder="Enter Favicon URL">
                            </div>
                            <div class="form-group">
                                <label for="og_image">Open Graph Image* (1200*630px)</label>
                                <input type="text" class="form-control" name="og_image" value="{{$product->og_image}}" placeholder="Enter Opengraph Image URL">
                            </div>
                            <div class="form-group">
                                <label for="og_image">Schema Image* (92*92px)</label>
                                <input type="text" class="form-control" name="schema_image" value="{{$product->schema_image}}" placeholder="Enter Opengraph Image URL">
                            </div>
                        ...
                        <div class="tab-pane" id="3">
                            <h3 class="text-[20px] my-4"><i class="fa-solid fa-circle"></i> Product Section</h3>
                            ...
                            <section class="grid grid-cols-2 gap-5">
                                ...
                                <div class="form-group">
                                    <label for="shop_now">Shop Now Button Link</label>
                                    <input type="text" name="shop_now" value="{{$product->shop_now}}" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <h3 class="text-[20px] my-4"><i class="fa-solid fa-circle"></i> Product Features</h3>

                            <section class="grid grid-cols-2 gap-5">
                                <div class="form-group">
                                    <label for="features_paragraph">Features Paragraph</label>
                                    <input type="text" name="features_paragraph" value="{{$product->features_paragraph}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="features_image">Features Image URL</label>
                                    <input type="text" name="features_image" value="{{$product->features_image}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="features_list">Features List <strong class="text-blue-500">Note: Use "//" after entering a line</strong></label>
                                    <textarea name="features_list" class="form-control" rows="5">{{$product->features_list}}</textarea>
                                </div>
                        ...
                        <div class="tab-pane" id="4">
                            <textarea name="content" class="tinymce">{{$product->content}}</textarea>
