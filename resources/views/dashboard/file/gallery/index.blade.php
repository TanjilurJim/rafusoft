...
@php
    ...
    $mypath = auth()->user()->user_id;
        $destinationPath ="filemanager/gallery/$mypath/";
...
@section('content')
    <section class="p-3">
        ...
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Gallery Images</h1>
        </div>
            ...
            @foreach ($icons as $image)
                ...
                <div class="modal fade" id="exampleModal{{$index-1}}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/gallery/rename" class="modal-content">
                            @csrf
                ...
                <div class="modal fade" id="deleteModal{{ $in-1 }}" tabindex="-1"
                    ...
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/gallery/delete" class="modal-content">
                            @csrf
                            <div class="modal-header">
