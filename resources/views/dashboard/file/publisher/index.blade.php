...
@php
    ...
    $mypath = auth()->user()->user_id;
        $destinationPath ="filemanager/publisher_image/$mypath/";

        if(auth()->user()->role == "superadmin"){
            $destinationPath ='publisher_image/';
        }
@endphp
...
@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Publisher Image (200 * 200) px</h1>
        </div>
                ...
                @foreach ($icons as $image)
                    ...
                    <div class="modal fade" id="exampleModal{{$index-1}}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form method="POST" action="/dashboard/file/publisher-image/rename" class="modal-content">
                                @csrf
                    ...
                    <div class="modal fade" id="deleteModal{{$in-1}}" tabindex="-1"
                        ...
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <form method="POST" action="/dashboard/file/publisher-image/delete" class="modal-content">
                                @csrf
                                <div class="modal-header">
