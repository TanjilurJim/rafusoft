...
@php
    ...
    $destinationPath = "filemanager/png/$mypath/";
...
@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">PNG | .png</h1>
        </div>


        @if (session('error'))
            <div class="p-3 text-white bg-red-500 rounded">
                {{ session('error') }}
            </div>
        @endif
        <section>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="dropzone-wrapper">
                                        ...
                                        <input type="file" name="png" class="dropzone">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($images as $image)
                        ...
                        <div class="modal fade" id="exampleModal{{ $index - 1 }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <form method="POST" action="/dashboard/file/png/rename" class="modal-content">
                                    @csrf
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel{{ $image->getFilename() }}">
                        ...
                        <div class="modal fade" id="deleteModal{{ $in - 1 }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <form method="POST" action="/dashboard/file/png/delete" class="modal-content">
                                    @csrf
                                    <div class="modal-header">
