...
@php
    ...
    $mypath = auth()->user()->user_id;
        $destinationPath ="filemanager/static_image/$mypath/";

        if(auth()->user()->role == "superadmin"){
            $destinationPath ='static_image/';
        }
@endphp
...
@section('content')
    <section class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Static Page Images</h1>
        </div>
            ...
            @foreach ($icons as $image)
                ...
                <div class="modal fade" id="exampleModal{{$index-1}}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/static-image/rename" class="modal-content">
                            @csrf
                ...
                <div class="modal fade" id="deleteModal{{ $in-1 }}" tabindex="-1"
                    ...
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/static-image/delete" class="modal-content">
                            @csrf
                            <div class="modal-header">
