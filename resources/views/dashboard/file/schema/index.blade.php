...
@php
    ...
    $mypath = auth()->user()->user_id;
        $destinationPath ="filemanager/schema_image/$mypath/";

        if(auth()->user()->role == "superadmin"){
            $destinationPath ='schema_image/';
        }
...
@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Schema Image (92 * 92) px</h1>
        </div>
    ...
    <div id="image-list" class=" p-3">
            ...
            @foreach ($icons as $image)
                <div class="border py-1 my-1 px-2 rounded flex items-center justify-between">
                    ...
                    <div class="flex gap-4">
                        ...
                        <button data-toggle="modal" data-target="#deleteModal{{ $in++ }}"
                            href="/dashboard/file/icon/delete/{{ $image->getFilename() }}"
                ...
                <div class="modal fade" id="exampleModal{{ $index - 1 }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/schema-image/rename" class="modal-content">
                            @csrf
                ...
                <div class="modal fade" id="deleteModal{{ $in - 1 }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/schema-image/delete" class="modal-content">
                            @csrf
                            <div class="modal-header">
        ...
        var noScrollDiv = document.getElementById('noScrollDiv');

        function preventScroll(e) {
            e.preventDefault();
        }

        noScrollDiv.addEventListener('mouseenter', function() {
            window.addEventListener('scroll', preventScroll, { passive: false });
        });

        noScrollDiv.addEventListener('mouseleave', function() {
