...
@php
    ...
    $destinationPath = "filemanager/favicon/$mypath/";
...
{{-- onchange="hnadaleSelect()" --}}

@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Favicon Image (32 * 32) px</h1>
        </div>
        ...
        <section class="mt-5">
            <div>
                <div id="croper-container" class="hidden">
                    ...
                    <input type="button" id="btnCrop" value="Crop" class="btn btn-orange mt-5" style="float: left">
                </div>
            ...
            @foreach ($icons as $image)
                ...
                <div class="modal fade" id="exampleModal{{ $index - 1 }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/favicon/rename" class="modal-content">
                            @csrf
                ...
                <div class="modal fade" id="deleteModal{{ $in - 1 }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/dashboard/file/favicon/delete" class="modal-content">
                            @csrf
                            <div class="modal-header">
