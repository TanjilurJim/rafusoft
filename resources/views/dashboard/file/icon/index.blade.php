...
@php
    ...
    $destinationPath = "filemanager/icons/$mypath/";
...
@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Icon | Upload .ico</h1>
        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dropzone-wrapper">
                                        <div class="dropzone-desc">
                                            ...
                                            <p>Choose an .ico file or drag it here.</p>
                                        </div>
                                        <input type="file" name="icon" class="dropzone">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($icons as $image)
                        ...
                        <div class="modal fade" id="exampleModal{{ $index - 1 }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <form method="POST" action="/dashboard/file/icon/rename" class="modal-content">
                                    @csrf
                        ...
                        <div class="modal fade" id="deleteModal{{ $in - 1 }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <form method="POST" action="/dashboard/file/icon/delete" class="modal-content">
                                    @csrf
                                    <div class="modal-header">
