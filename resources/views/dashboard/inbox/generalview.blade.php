...
@section('content')
    <section class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white flex justify-between items-center">
            <h1 class="text-[20px]"><strong>General:</strong> Message || No. {{$no}}</h1>
        ...
        <div class="mt-4">
            ...
            <div class="flex items-center gap-5 mt-3 ">
                <a href="/dasboard/inbox/general/" class="btn btn-orange">Back</a>
                <form action="/dasboard/inbox/general/status/{{ $message->id }}" method="POST">
                    @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form method="POST" action="/dasboard/inbox/general/delete/{{ $message->id }}">
              @csrf @method('DELETE')
        ...
        <script>
            const handlegreat =(id, great, button)=>{
                fetch(`/dasboard/inbox/general/great/${id}/${great}`)
