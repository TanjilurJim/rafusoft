    ...
    <section class="p-3">
        ...
        <form class="my-5" method="POST">
            ...
            <div class="form-group">
                ...
                <input value="{{ $refund->headingone }}" name="headingone" type="text" class="form-control"
                    placeholder="Enter Heading (h1)">
            </div>
            <div class="form-group">
                <label for="heading">Heading (h2)</label>
                <input value="{{ $refund->headingtwo }}" name="headingtwo" type="text" class="form-control"
                    placeholder="Enter Heading (h2)">
            </div>
            <textarea name="content" class="tinymce">{!! $refund->content !!}</textarea>
