...
@section('content')
    <div class="p-3">
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h1 class="text-[20px]">Invoice Setting Edit</h1>
        </div>
        <section>
            <div class=" my-3">
                <label for="logo">Your Logo</label>
                <img  id="prev-img" src="{{$profile->logo}}" class="rounded w-[180px]  overflow-hidden" >
                ...
                <form method="POST" enctype="multipart/form-data" class="action" enctype="multipart/form-data">
                    ...
                    <div class="from-control">
                        ...
                        <textarea rows="1" name="from" class="resize-none overflow-hidden auto-rows-auto p-2 border focus:outline-none text-gray-500 border-slate-100 w-full  rounded">{{$profile->from}}</textarea>
                     @error('from')
                    ...
                    <div class="from-control">
                        ...
                        <textarea rows="1" name="notes" class="resize-none auto-rows-auto overflow-hidden p-2 border focus:outline-none text-gray-500 border-slate-100 w-full  rounded"  
                        placeholder="Notes - any relevant information not already covered">{{$profile->notes}}</textarea>
                        @error('notes')
                        <p class="my-3 text-red-600">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="from-control">
                        ...
                        <textarea rows="1" name="terms" class="resize-none overflow-hidden auto-rows-auto p-2 border focus:outline-none text-gray-500 border-slate-100 w-full  rounded"  
                        placeholder="Terms and conditions - late fees, payment methods, delivery schedule">{{$profile->terms}}</textarea>
                        @error('terms')
                        <p class="my-3 text-red-600">{{$message}}</p>
                        @enderror
                    </div>
