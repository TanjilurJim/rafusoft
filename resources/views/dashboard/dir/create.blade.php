...
@section('content')
    <section class="p-3">
        ...
        @if (auth()->user()->dir_limit > count($dir))
            <div class="my-4 d-flex justify-content-between items-center">
                <button id="tab-one-button" onclick="tab_one()" class="btn flex items-center gap-2"><i class="fa-regular fa-clipboard "></i> <p>Meta & Banner</p></button>
                <button id="tab-two-button" onclick="tab_two()" class="btn flex items-center gap-2"><i class="fa-regular fa-clipboard"></i> <p>Favicon And OG:Image</p></button>
                <button id="tab-three-button" onclick="tab_three()" class="btn flex items-center gap-2"><i  class="fa-regular fa-clipboard"></i> Schema</button>
                <button id="tab-four-button" onclick="tab_four()" class="btn flex items-center gap-2"><i   class="fa-solid fa-paper-plane"></i> Finish</button>
            </div>
            <form method="POST">
                @csrf
                ...
                <section id="tab_one" class="hidden">
                    <div class="my-4 grid grid-cols-2 gap-5">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Slug" name="slug" class="form-control p-2">
                            @error('slug')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" onchange="change_title()" placeholder="Title" id="title"
                                name="title" class="form-control p-2">
                            @error('title')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Meta Keyword" name="meta_keyword" class="form-control p-2">
                            @error('meta_keyword')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Meta Description" id="meta_description"
                                onchange="meta_descriptionChange()" name="meta_description" class="form-control p-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Banner Head (h1)" name="banner_head"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="https://rafusoft.com/dir" readonly name="page_url"
                                class="form-control p-2">
                            @error('page_url')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="flex justify-between gap-10">
                        <div class="my-4 w-1/2">
                            <div class="form-group">
                                ...
                                <img id="favicon_img" class="my-3 rounded" src="{{ asset('assets/img/favicon.png') }}"
                                    alt="favicon">
                                <input id="favicon" value="{{ asset('assets/img/favicon.png') }}"
                                    onchange="chnageFav()" type="text" placeholder="url" name="favicon"
                                    class="form-control p-2">
                                @error('favicon')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <img id="og_image" class="my-3 rounded" src="{{ asset('/og_image/rafusoft.jpg') }}"
                                    alt="og image placeholder">
                                <input id="og" value="{{ asset('/og_image/rafusoft.jpg') }}"
                                    onchange="chnageOg()" type="text" placeholder="url" name="og"
                                    class="form-control p-2">
                                @error('og')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <section class="grid grid-cols-2 gap-x-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Industry Type (Software Development)"
                                            name="industry_type" class="form-control p-2">
                                        @error('industry_type')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-10">
                        <section class="mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Headline" id="headline" name="artical_headline"
                                    class="form-control p-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Artical Description" id="artical_description"
                                    name="artical_description" class="form-control p-2">
                            ...
                            <div class="form-group">
                                ...
                                <select name="author_name" class="form-control p-2">
                                    <option value="Rafusoft" selected>Rafusoft</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Author url" name="author_url"
                                    class="form-control p-2" value="https://rafusoft.com">
                                @error('author_url')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Publisher" name="publisher" class="form-control p-2"
                                    value="Rafusoft">
                                @error('publisher')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <section>
                            <div class="form-group">
                                ...
                                <input onchange="handlePublisherLogo()" id="publisher"
                                    ...
                                    placeholder="Publisher logo url" name="publisher_logo"
                                    class="form-control p-2 mt-full">
        ...
        @else
            <div class="h-[60vh] flex flex-col justify-center items-center">
                <div class="w-96 bg-slate-200 shadow-inner  text-center py-5 rounded-sm">
        ...
        <script>
            ...
            const meta_descriptionChange = () => {
                const title = document.getElementById('meta_description').value;
                document.getElementById('artical_description').value = title;
            }
        </script>
    </section>
@endsection
