...
@section('content')
    <section class="p-3">
        ...
        <div class="bg-[#343A40] p-3 rounded text-white">
            <h5 class="text-[20px]">Dir Page Create</h5>
        </div>
        ...
        <form method="POST">
            ...
            <section id="tab_one" class="hidden">
                <div class="my-4 grid grid-cols-2 gap-5">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$dir->page_url}}" type="text" value="https://rafusoft.com/dir" readonly name="page_url" class="form-control p-2">
                        @error('page_url')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="flex justify-between gap-10">
                    <div  class="my-4 w-1/2">
                        <div class="form-group">
                            ...
                            <img id="favicon_img" class="my-3 rounded" src="{{$dir->favicon}}" alt="favicon">
                            <input id="favicon" onclick="chnageFav()" value="{{$dir->favicon}}" type="text" placeholder="url" name="favicon" class="form-control p-2">
                            @error('favicon')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <img id="og_image" class="my-3 rounded" src="{{$dir->og}}" alt="og image placeholder">
                            <input id="og" onchange="chnageOg()" value="{{$dir->og}}" type="text" placeholder="url" name="og" class="form-control p-2">
                            @error('og')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="grid grid-cols-2 gap-10">
                    ...
                    <section>
                        ...
                        <div class="form-group ">
                            ...
                            <input id="schema" onchange="changeSchema()" value="{{$dir->schema_image_url}}" type="text" placeholder="Schema image url*" name="schema_image_url" class="form-control p-2">
            ...
            <section id="tab_four" class="hidden">
                <section>
                    ...
                    <div class="form-group">
                        <label>Publish Or Unpublish*</label>
