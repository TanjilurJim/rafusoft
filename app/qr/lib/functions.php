...
if (!class_exists('QRcdrFn', false)) {
    ...
    class QRcdrFn
    {
		...
		protected $config  = array(
			...
			'qrcodes_dir' => 'http://localhost/rafusoft/application/libraries/qr/qrcodes',                 // qr codes directory
			...
			'relative_path' => '../../../libraries/qr/'         // use this option if you place the main index.php in different location, this must be the path of the main qrcdr directory, relative to the index
			);
        ...
        {
            // $relative = $this->relativePath();
            $relative = base_url()."assets/frontend/qr/";
